...
$GLOBALS['TL_LANG']['al_frontend']['eventCancelHead'] = " abgesagt";
$GLOBALS['TL_LANG']['al_frontend']['eventCancelMsg-1'] = "Hallo zusammen,\n\nder kommende Termin ";
$GLOBALS['TL_LANG']['al_frontend']['eventCancelMsg-2'] = "ist abgesagt.\n\nGruß,\n";
